...
def admin_users():
    ...
    if request.method == "POST":
        ...
        if action == "update_role":
            ...
            cursor.execute("UPDATE users SET password = ? WHERE id = ?", (new_pw_hash, user_id))
            conn.commit()
            ...
            cursor.execute("""INSERT INTO users (first_name, last_name, username, password, role) VALUES (?, ?, ?, ?, ?)""", (first, last, username, hashed, role))
